...
class Remixer:
    ...
    def mix(self, path_to_audio, timespan_video, timespan_audio):
...
def main():
    ...
    remixer.mix(path_to_audio='music/Over The Edge - Akon.mp3', timespan_audio=[5, 100], timespan_video=[3, 200])
    remixer.mix(path_to_audio='music/Placebo,David Bowie - Without You I\'m Nothing.mp3', timespan_audio=[5, 100], timespan_video=[200, 400])
    remixer.mix(path_to_audio='music/Queen - There Must Be More To Life Than This (William Orbit Mix).mp3', timespan_audio=[5, 100], timespan_video=[400, 500])
